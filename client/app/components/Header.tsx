...
import { Trophy, Sparkles, X, Star, LogIn, LogOut } from "lucide-react";
...
const avatars = [
  ...
  { id: 8, name: "", src: "/8.png" },
  { id: 9, name: "", src: "/9.png" },
  { id: 10, name: "", src: "/10.png" },
  { id: 11, name: "", src: "/11.png" },
  { id: 12, name: "", src: "/12.png" },
  { id: 13, name: "", src: "/13.png" },
  { id: 14, name: "", src: "/14.png" },
  { id: 15, name: "", src: "/15.png" },
  { id: 16, name: "", src: "/16.png" },
  { id: 17, name: "", src: "/17.png" },
  { id: 18, name: "", src: "/18.png" },
  { id: 19, name: "", src: "/19.png" },
  { id: 20, name: "", src: "/20.png" },
];
            ...
            <div className="flex items-center gap-2 md:gap-4 relative">
              <Link href="/leaderboard">
                ...
                >
                  ...
                  <span className="text-[#5D3191] font-bold text-[10px] uppercase tracking-widest hidden md:block">
                    Шилдэгүүд
                  </span>
                </motion.div>
              </Link>
